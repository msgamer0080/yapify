    ...
    <div class="wrapper-left">
        <div class="sidebar-left">
          <div class="grid-sidebar" style="margin-top: 12px">
            <div class="icon-sidebar-align">
              <img src="assets/images/logo.png" alt="" height="30px" width="30px" />
            </div>
          </div>
          ...
          <div class="grid-sidebar ">
            <div class="icon-sidebar-align">
              <img src="assets/images/settings.png" alt="" height="26.25px" width="26.25px" />
            </div>
      ...
      <div class="grid-posts">
        ...
        <div class="wrapper-right">
            ...
            <input type="text" class="form-control search-input"  placeholder="Search YAPIFY">
